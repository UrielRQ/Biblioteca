...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        <form action="{{ route('categorias.store') }}" method="POST" class="bg-gray-800 shadow-md rounded-lg p-6">
            @csrf
            <div class="mb-4">
                <label for="nombre" class="block text-white font-bold mb-2">Nombre de la Categoría:</label>
