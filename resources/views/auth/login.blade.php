        ...
        <div class="w-full max-w-md space-y-8">
            ...
            <div id="login-box" class="transition-all duration-500 ease-in-out">
                <div class="mb-8">
                    ...
                    <p class="text-gray-500 mt-2">Accede a tu panel de administración.</p>
                </div>
                ...
                <form action="{{ route('login') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" required placeholder="admin@biblioteca.com" 
                                class="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors">
                        </div>
                    </div>
                    ...
                    <button type="submit" class="w-full bg-blue-900 hover:bg-blue-800 text-white font-bold py-3.5 rounded-lg shadow-md transition duration-300 transform hover:-translate-y-0.5">
                        Ingresar al Sistema
                    </button>
                </form>
            ...
            <div id="register-box" class="hidden transition-all duration-500 ease-in-out">
                <div class="mb-8">
                    ...
                    <p class="text-gray-500 mt-2">Regístrate para gestionar préstamos.</p>
                </div>
                ...
                <form action="{{ route('register') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="name" required placeholder="Tu nombre" 
                                class="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none transition-colors">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Repetir</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
